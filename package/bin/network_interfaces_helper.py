...
KV_STORE_COLLECTION = "cc_network_interfaces"
        ...
        kv_data.append(
            {
                ...
                "max_tx": row["Max Tx"],
                "avg_tx": row["Avg Tx"],
                "output_error_rate": row["Output Error Rate"],
                "output_discard_rate": row["Output Discard Rate"],
                "min_rx": row["Min Rx"],
                "max_rx": row["Max Rx"],
                "avg_rx": row["Avg Rx"],
                "input_error_rate": row["Input Error Rate"],
                "input_discard_rate": row["Input Discard Rate"],
