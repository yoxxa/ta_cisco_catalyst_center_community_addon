        ...
        kv_data.append(
            {
                ...
                "device_role": row["Device Role"],
                "ip_address": row["IP Address"],
                "location": row["Location"],
                "serial_number": row["Serial Number"],
                "current_version": row["Current Version"],
                "code_upgrade_date": row["Code Upgrade Date"],
                "previous_upgrade_date": row["Previous Upgrade Date"],
                "current_smu": row["Current SMU"],
                "current_smu_upgrade_date": row["Current SMU Upgrade Date"],
                "upgrade_failure_reason": row["Upgrade Failure Reason"],
